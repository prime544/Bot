...
if (
  ...
  try {
    const host = "play.lynoxnetwork.com.tr";
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              "Minecraft sunucusu şu anda **çevrimdışı** görünüyor."
            )
            .addFields({
              name: "🌐 Sunucu Adresi",
              value:
    ...
    return message.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setFooter({
            text:
              "LynoxNetwork • Canlı Sunucu Durumu"
          })
      ]
    });
    ...
    return message.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription(
            "Minecraft sunucusunun durumu kontrol edilirken bir hata oluştu."
          )
          .addFields({
            name: "🌐 Sunucu",
            value:
